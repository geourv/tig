...
També cal separar els estàndards de l'ecosistema de programari. L'**OGC** publica especificacions tècniques; l'**OSGeo** és una fundació que dona suport jurídic, organitzatiu i comunitari a projectes geoespacials oberts. **QGIS** és una aplicació SIG; **GDAL**, incloses les funcionalitats vectorials conegudes històricament com a OGR, llegeix, escriu i transforma dades; **PROJ** executa operacions de coordenades; i **GEOS** implementa el model geomètric Simple Features i operacions de geometria plana. Són rols diferents, encara que QGIS integri aquestes biblioteques {% cite osgeoFoundationAbout2026 qgisUserGuide344 rouaultGDAL2026 projContributorsPROJ2026 geosContributorsGEOS2025 %}.
